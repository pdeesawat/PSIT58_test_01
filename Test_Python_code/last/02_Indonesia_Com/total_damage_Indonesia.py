...
for i in range(5):
    ...
    trace.append(go.Scatter(x = year_x, y = damage_z, name = type_z[i], mode = 'markers',
    marker = dict(color = [fill_colors[i] for k in damage_z], size = [size_fill[i] for k in damage_z])))
