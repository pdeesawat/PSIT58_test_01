...
for iy in listdata:
        if iy[0] == 'Vietnam' and iy[2] in all_disaster:
            all_disaster[iy[2]] += 1
...
"layout": {"title":"Vietnam's Average Disaster from 2000 to 2014", "annotations": [{"font": {"size": 20},
"showarrow": False, "text": ""}]}}

url = py.plot(make_circle, filename='Vietnam\'s Average Disaster from 200o to 2014')