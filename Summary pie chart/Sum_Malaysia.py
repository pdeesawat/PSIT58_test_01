...
for iy in listdata:
        if iy[0] == 'Malaysia' and iy[2] in all_disaster:
            all_disaster[iy[2]] += 1
...
"layout": {"title":"Malaysia's Average Disaster from 2000 to 2014", "annotations": [{"font": {"size": 20},
"showarrow": False, "text": ""}]}}

url = py.plot(make_circle, filename='Malaysia\'s Average Disaster from 200o to 2014')